export default {
	...
	_unitRaw() { try { return (typeof LBDateUnit !== 'undefined' && LBDateUnit.selectedOptionValue) || 'Months'; } catch (e) { return 'Months'; } },
	_num() { try { const n = parseInt(LBDateNum.text, 10); return (n && n > 0) ? n : 6; } catch (e) { return 12; } },
